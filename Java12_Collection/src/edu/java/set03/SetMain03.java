...
//		System.out.println(score1);
		...
		scores.add(score3);
		// -> (1) equals만 override를 하고 hashCode를 override하지 안으면 score3이 Set에 추가된다.
		// -> (2) equals와 hashCode를 모두 저절하게 override하면 score3은 Set에 추가되지 않는다.
		
		// equals()가 true이면 hashCode() 리턴 값이 같다.
		// hashCode() 리턴 값이 다르면 equals()가 false이다.
		// Set은 두 객체의 중복(같은지 다른지) 여부를 검사할 때 hashCode()를 먼저 비교하고,
		// hashCode()가 같으면 equals()메서드를 호출해서 중복여부를 검사한다!!
